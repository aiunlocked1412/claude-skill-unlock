...
**100 Claude Code Skills** ครอบคลุม **9 หมวด**:

| หมวด | จำนวน | ตัวอย่าง Skills |
|------|-------|-----------------|
| 🎬 Content Creator | 11 | YouTuber, TikToker, Blogger, Podcaster, Course Creator |
| 📣 Marketing & Sales | 14 | Digital Marketer, SEO, Copywriter, Brand Strategist, Sales Pro |
| 💻 Tech & Development | 13 | Programmer, Data Analyst, Mobile Dev, Security, AI Engineer |
| 🎨 Design & Creative | 13 | Graphic, UX, Motion, Illustrator, 3D, Interior |
| 💼 Business & Service | 15 | Consultant, Accountant, HR, Lawyer, Crypto Trader |
| 📚 Education & Health | 15 | Teacher, Coach, Doctor, Yoga, Meditation |
| 💰 Lifestyle & Personal | 7 | Personal Finance, Resume, Interview, Wedding, Travel |
| 🍽️ Hospitality & Service | 5 | Restaurant, Hotel, Tour Guide, Salon, Florist |
| ⚙️ Productivity & Modern Work | 7 | Meeting, Email, Notion, PM, Async, EA |
...
└── skills/
    ├── 01-content-creator/      # 11 skills
    ├── 02-marketing/            # 14 skills
    ├── 03-tech/                 # 13 skills
    ├── 04-design/               # 13 skills
    ├── 05-business/             # 15 skills
    ├── 06-education-health/     # 15 skills
    ├── 07-lifestyle/            # 7 skills (NEW)
    ├── 08-hospitality/          # 5 skills (NEW)
    └── 09-productivity/         # 7 skills (NEW)
```
...
*v1.1.0 — อัปเดตล่าสุด: 2026-04-16 — 100 skills, 9 categories*
